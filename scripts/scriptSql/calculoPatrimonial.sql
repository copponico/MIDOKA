...
SELECT 'Lsup' AS 'QUINCENA',
       ...
       ROUND(t2.PAGOS+t7.FACTURACION, 0)*.1 AS 'comisionesFuturas',
       ...
       ROUND(t17.COMPRA, 0) AS 'compraProveedor',
       ROUND(t21.PAGO, 0) AS 'pagoProveedor',
       ROUND(t19.COBRANZA, 0) AS 'COBRO',
       ROUND(t11.comisionesPagas, 0) AS 'comisionesPagas',
       ROUND(t15.comisionesPagasPablo, 0) AS 'comisionPagaGerencia',
       ROUND(t16.comisionesPagasExtra, 0) AS 'comisionesPagasExtra'
FROM
